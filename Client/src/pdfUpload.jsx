...
return(
    <>
        <div className='bg-[#5d4889] mt-[100px] mb-[40px] w-[500px] m-[auto] flex flex-col justify-center items-center py-[20px]'
      ...
      <div>
        ...
        <input className='w-[300px]' type='text' placeholder='Enter here...' onChange={handleInput }  name='title' value={book.name}/>
      </div><br/>
        ...
        <div>
          ...
          <input className='w-[300px]' type='text' placeholder='Enter here...' onChange={handleInput }  name='eddition' value={book.addition}/>
        </div><br/>
       ...
       <button onClick={uploadPdf} className='text-white bg-[#fb4a8b] rounded-xl w-[100px] px-[10px] py-[5px]'>{loading===false ?<h1>Upload</h1>:<h1>Uploading.....</h1>}</button>

       {uDetail.uploadUrl===true && <ShowDownload/>}
        </div>
